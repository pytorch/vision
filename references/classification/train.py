...
def main(args):
    ...
    data_loader, data_loader_test, train_sampler = load_data(train_dir, val_dir, args.batch_size, args.batch_size, args.workers, args.cache_dataset, args.distributed)
