...
torchrun --nproc_per_node=8 train.py  --model efficientnet_b4 --workers 12 --weights EfficientNet_B4_Weights.DEFAULT 
...
torchrun --nproc_per_node=8 train.py  --model shufflenet_v2_x1_0 --workers 12 --weights ShuffleNet_V2_X1_0_Weights.DEFAULT -
