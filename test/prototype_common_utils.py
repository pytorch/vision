...
from torchvision.prototype import vision_tensors
...
def make_label_loader(*, extra_dims=(), categories=None, dtype=torch.int64):
    ...
    def fn(shape, dtype, device):
        ...
        return vision_tensors.Label(data, categories=categories)
...
def make_one_hot_label_loader(*, categories=None, extra_dims=(), dtype=torch.int64):
    ...
    def fn(shape, dtype, device):
        ...
        return vision_tensors.OneHotLabel(data, categories=categories)
