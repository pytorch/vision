...
DISPATCHER_INFOS = [
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.crop_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.resized_crop_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.pad_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.perspective_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.elastic_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={
            ...
            datapoints.BBoxes: F.center_crop_bounding_box,
    ...
    DispatcherInfo(
        ...
        kernels={datapoints.BBoxes: F.clamp_bounding_box},
        test_marks=[
            skip_dispatch_datapoint,
        ],
    ),
    DispatcherInfo(
        ...
        kernels={datapoints.BBoxes: F.convert_format_bounding_box},
        test_marks=[
            skip_dispatch_datapoint,
        ],
    ),
