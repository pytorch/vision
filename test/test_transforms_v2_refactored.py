...
class TestResize:
    ...
    def test_image_correctness(self, size, interpolation, use_max_size, fn):
        ...
        expected = F.to_image(F.resize(F.to_image_pil(image), size=size, interpolation=interpolation, **max_size_kwarg))
...
class TestHorizontalFlip:
    ...
    def test_image_correctness(self, fn):
        ...
        actual = fn(image)
        expected = F.to_image(F.horizontal_flip(F.to_image_pil(image)))
...
class TestAffine:
    ...
    def test_transform_image_correctness(self, center, interpolation, fill, seed):
        ...
        torch.manual_seed(seed)
        expected = F.to_image(transform(F.to_image_pil(image)))
...
class TestVerticalFlip:
    ...
    def test_image_correctness(self, fn):
        ...
        actual = fn(image)
        expected = F.to_image(F.vertical_flip(F.to_image_pil(image)))
...
class TestAdjustBrightness:
    ...
    def test_image_correctness(self, brightness_factor):
        ...
        expected = F.to_image(F.adjust_brightness(F.to_image_pil(image), brightness_factor=brightness_factor))
