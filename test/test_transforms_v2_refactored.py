...
class TestResize:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.resize_bounding_box, datapoints.BoundingBoxes),
    ...
    def _reference_resize_bounding_box(self, bounding_box, *, size, max_size=None):
        ...
        return datapoints.BoundingBoxes.wrap_like(bounding_box, expected_bboxes, spatial_size=(new_height, new_width))
...
class TestHorizontalFlip:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.horizontal_flip_bounding_box, datapoints.BoundingBoxes),
    ...
    def _reference_horizontal_flip_bounding_box(self, bounding_box):
        ...
        return datapoints.BoundingBoxes.wrap_like(bounding_box, expected_bboxes)
...
class TestAffine:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.affine_bounding_box, datapoints.BoundingBoxes),
...
class TestVerticalFlip:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.vertical_flip_bounding_box, datapoints.BoundingBoxes),
...
class TestRotate:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.rotate_bounding_box, datapoints.BoundingBoxes),
