...
class TestResize:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.resize_bounding_boxes, datapoints.BBoxes),
    ...
    def _reference_resize_bounding_boxes(self, bounding_boxes, *, size, max_size=None):
        ...
        return datapoints.BBoxes.wrap_like(bounding_boxes, expected_bboxes, spatial_size=(new_height, new_width))
...
class TestHorizontalFlip:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.horizontal_flip_bounding_boxes, datapoints.BBoxes),
    ...
    def _reference_horizontal_flip_bounding_boxes(self, bounding_boxes):
        ...
        return datapoints.BBoxes.wrap_like(bounding_boxes, expected_bboxes)
...
class TestAffine:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.affine_bounding_boxes, datapoints.BBoxes),
...
class TestVerticalFlip:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.vertical_flip_bounding_boxes, datapoints.BBoxes),
...
class TestRotate:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (F.rotate_bounding_boxes, datapoints.BBoxes),
