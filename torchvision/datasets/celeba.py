        ...
        target_type (string or list, optional): Type of target to use, ``attr``, ``identity``, ``bbox``,
            ...
            The targets represent:
                ...
                - ``bbox`` (Tensor shape=(4,) dtype=int): bounding box (x, y, width, height).
                  **Warning**: These bounding box coordinates correspond to the original
                  uncropped CelebA images, not the cropped and aligned images returned by
                  this dataset. As a result, the coordinates will not match and may fall
                  outside the image boundaries. See
                  `Issue #9008 <https://github.com/pytorch/vision/issues/9008>`_ for
