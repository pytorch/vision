...
def affine(img, angle, translate, scale, shear, resample=0, fillcolor=None):
    ...
    assert shear[0] > -89.99 and shear[0] < 89.99, "x-axis shear must be with the range [-89.99, 89.99]"
    assert shear[1] > -89.99 and shear[1] < 89.99, "y-axis shear must be with the range [-89.99, 89.99]"
