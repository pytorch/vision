...
class _BaseMixUpCutMix(Transform):
    ...
    def forward(self, *inputs):
        ...
        if has_any(flat_inputs, PIL.Image.Image, vision_tensors.BoundingBoxes, vision_tensors.Mask):
    ...
    def _check_image_or_video(self, inpt: torch.Tensor, *, batch_size: int):
        expected_num_dims = 5 if isinstance(inpt, vision_tensors.Video) else 4
...
class MixUp(_BaseMixUpCutMix):
    ...
    def _transform(self, inpt: Any, params: Dict[str, Any]) -> Any:
        ...
        elif isinstance(inpt, (vision_tensors.Image, vision_tensors.Video)) or is_pure_tensor(inpt):
