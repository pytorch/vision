...
@_register_kernel_internal(normalize, vision_tensors.Image)
...
@_register_kernel_internal(normalize, vision_tensors.Video)
...
@_register_kernel_internal(gaussian_blur, vision_tensors.Image)
...
@_register_kernel_internal(gaussian_blur, vision_tensors.Video)
...
@_register_kernel_internal(to_dtype, vision_tensors.Image)
...
@_register_kernel_internal(to_dtype, vision_tensors.Video)
...
@_register_kernel_internal(to_dtype, vision_tensors.BoundingBoxes, vision_tensor_wrapper=False)
@_register_kernel_internal(to_dtype, vision_tensors.Mask, vision_tensor_wrapper=False)
def _to_dtype_tensor_dispatch(inpt: torch.Tensor, dtype: torch.dtype, scale: bool = False) -> torch.Tensor:
    # We don't need to unwrap and rewrap here, since VisionTensor.to() preserves the type
