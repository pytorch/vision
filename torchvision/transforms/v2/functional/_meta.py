...
def _get_dimensions_image_cvcuda(image: "cvcuda.Tensor") -> list[int]:
    return [image.shape[3], image.shape[1], image.shape[2]]


if CVCUDA_AVAILABLE:
    _register_kernel_internal(get_dimensions, _import_cvcuda().Tensor)(_get_dimensions_image_cvcuda)
