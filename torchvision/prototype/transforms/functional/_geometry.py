...
@dispatch(
    {
        features.Image: horizontal_flip_image,
...
@dispatch(
    {
        features.Image: center_crop_image,
    }
)
...
@dispatch(
    {
        features.Image: resized_crop_image,
    }
)
def resized_crop(
    input: T,
