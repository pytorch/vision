...
@handle_legacy_interface(
    dict(
        pretrained=("weights", FasterRCNN_ResNet50_FPN_Weights.Coco_RefV1),
        pretrained_backbone=("weights_backbone", ResNet50_Weights.ImageNet1K_RefV1),
    )
)
...
@handle_legacy_interface(
    dict(
        pretrained=("weights", FasterRCNN_MobileNet_V3_Large_FPN_Weights.Coco_RefV1),
        pretrained_backbone=("weights_backbone", MobileNet_V3_Large_Weights.ImageNet1K_RefV1),
    )
)
...
@handle_legacy_interface(
    dict(
        pretrained=("weights", FasterRCNN_MobileNet_V3_Large_320_FPN_Weights.Coco_RefV1),
        pretrained_backbone=("weights_backbone", MobileNet_V3_Large_Weights.ImageNet1K_RefV1),
    )
)
