...
from torchvision.prototype.datasets.utils import EncodedData, EncodedImage, LabelWithCategories
...
def _prepare_sample(
    ...
    *,
    ...
    return dict(
        ...
        label=LabelWithCategories.from_category(category, categories=categories),
    )
