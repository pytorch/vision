...
DEFAULT_DECODER_MAP: Dict[DatasetType, Optional[Callable[[io.IOBase], Dict[str, Any]]]] = {
    DatasetType.RAW: raw,
...
def load(
    name: str,
    *,
    decoder: Optional[Callable[[io.IOBase], Dict[str, Any]]] = DEFAULT_DECODER,  # type: ignore[assignment]
    split: str = "train",
    **options: Any,
