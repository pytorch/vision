...
def make_grid(
    ...
    Args:
        ...
        value_range (tuple, optional): Attention: range changed to value_rangetuple.
            (min, max) where min and max are numbers, then these numbers 
            are used to normalize the image. By default, min and max
