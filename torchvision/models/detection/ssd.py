...
def ssd300_vgg16(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        highres (bool, optional): By default (False), input-resolution is 300x300. If True is passed, it is 512x512.
    ...
    backbone = _vgg_extractor(backbone, highres, trainable_backbone_layers)
    if highres:
        anchor_generator = DefaultBoxGenerator(
...
def ssd512_vgg16(
    ...
    **kwargs: Any,
    ...
    """The SSD512 model is based on the `SSD: Single Shot MultiBox Detector
    <https://arxiv.org/abs/1512.02325>`_ paper

    .. betastatus:: detection module

    The interface is based on ssd300_vgg16.

    Args:
        weights (:class:`~torchvision.models._api.WeightsEnum`, optional): The pretrained
                weights to use. By default, no pre-trained weights are used.
        progress (bool, optional): If True, displays a progress bar of the download to stderr
            Default is True.
        num_classes (int, optional): number of output classes of the model (including the background)
        weights_backbone (:class:`~torchvision.models.VGG16_Weights`, optional): The pretrained weights for the
    ...
    """
    return ssd300_vgg16(weights, progress, num_classes, weights_backbone, trainable_backbone_layers, True, **kwargs)
