...
class RetinaNet(nn.Module):
    ...
    Args:
        ...
        proposal_matcher (nn.Module): Module that matches the proposals generated by groudn truth and predictions.
            Defaults to a Matcher module which matches the predictions.
    ...
    def __init__(
        ...
        proposal_matcher: Optional[nn.Module] = None,
...
def retinanet_resnet50_fpn(
    ...
    trainable_backbone_layers: bool = None,
    **kwargs: Any,
) -> RetinaNet:
    """
