...
class RandomRotation(object):
    ...
    def __init__(self, degrees, resample=False, expand=False, center=None, translate=None):
    ...
    @staticmethod
    def get_params(degrees, resample, expand, center, translate):
        ...
        return angle, resample, expand, center, translate
    ...
    def __call__(self, img):
        ...
        params = self.get_params(self.degrees, self.resample, self.expand,
