...
std::tuple<Tensor, Tensor> ps_roi_align_forward_kernel(
  ...
  if (dtype == kFloat) {
    ps_roi_align_forward_kernel_impl<float>(
        num_rois,
    ...
    ps_roi_align_forward_kernel_impl<double>(
        num_rois,
...
Tensor ps_roi_align_backward_kernel(
  ...
  if (dtype == kFloat) {
    ps_roi_align_backward_kernel_impl<float>(
        grad.numel(),
    ...
    ps_roi_align_backward_kernel_impl<double>(
        grad.numel(),
